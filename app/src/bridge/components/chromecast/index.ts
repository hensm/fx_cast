...
export function handleSessionMessage (message: any) {
    if (!message.data.internalSessionId) {
        console.error("Session message missing `internalSessionId`");
        return;
    }

    const sessionId = message.data.internalSessionId;
...
export function handleMediaMessage (message: any) {
    if (!message.data.internalMediaSessionId) {
        console.error("Media message missing `internalMediaSessionId`");
        return;
    }

    const mediaId = message.data.internalMediaSessionId;
